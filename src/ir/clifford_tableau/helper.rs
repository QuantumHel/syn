...
fn _is_i(pauli_letter: PauliLetter) -> bool {
...
fn _is_not_y(pauli_letter: PauliLetter) -> bool {
    pauli_letter != PauliLetter::Y
}
...
pub(super) fn clean_signs<G>(repr: &mut G, ct: &mut CliffordTableau, row_permutation: &[usize])
where
    G: CliffordGates,
{
