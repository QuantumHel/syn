...
impl Connectivity {
    ...
    pub fn from_graph(mut graph: StableUnGraph<NodeWeight, EdgeWeight, GraphIndex>) -> Self {
...
// use petgraph::prelude::{EdgeRef, StableUnGraph};
// use petgraph::visit::{Bfs, IntoEdgeReferences, IntoNodeIdentifiers, VisitMap, Visitable};
// use petgraph::{
//     algo::articulation_points::articulation_points,
//     graph::NodeIndex,
//     visit::{IntoNodeReferences, NodeIndexable, NodeRef},
...
//     graph: StableUnGraph<NodeWeight, EdgeWeight, GraphIndex>,
//     non_cutting: Vec<GraphIndex>,
//     prev: HashMap<(NodeIndex<usize>, NodeIndex<usize>), Option<NodeIndex<usize>>>,
//     distance: HashMap<(NodeIndex<GraphIndex>, NodeIndex<GraphIndex>), EdgeWeight>,
// }
...
//         if !self
//             .prev
//             .contains_key(&(NodeIndex::new(u), NodeIndex::new(v)))
//         {
//             return Vec::new();
//         }

//         while u != v {
//             if let Some(new_v) = self.prev.get(&(NodeIndex::new(u), NodeIndex::new(v))) {
//                 v = new_v.unwrap().index();
//                 path.push(v);
//             }
//         }
